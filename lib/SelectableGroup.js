...
var SelectableGroup = (function(_Component) {
  ...
  function SelectableGroup(props) {
    ...
    _this.mouseDown = function(e) {
      if (_this.mouseDownStarted || _this.props.disabled || e.button !== 0) return
      _this.updateWhiteListNodes()
      ...
      if (_this.props.resetOnStart && !_this.inSelectboxBlacklist(e.target)) {
      ...
      if (!_this.inSelectboxBlacklist(e.target)) {
        e.preventDefault()
    ...
    _this.mouseUp = function(event) {
      ...
      if (!_this.mouseMoved && (0, _nodeInRoot2.default)(e.target, _this.rootNode)) {
        if (_this.props.resetOnStart && _this.inSelectboxBlacklist(_this.mouseDownData.target)) {
          _this.clearSelection()
        }
    ...
    _this.selectboxBlacklist = new Map()
  ...
  _createClass(SelectableGroup, [
    ...
    {
      key: 'inSelectboxBlacklist',
      value: function inSelectboxBlacklist(target) {
        ...
        var shouldBeIgnored = []
          .concat(
            _toConsumableArray(document.querySelectorAll(this.props.selectboxBlacklist.join(', ')))
          )
          .some(function(ignoredNode) {
            return target === ignoredNode || ignoredNode.contains(target)
          })
...
SelectableGroup.propTypes = {
  ...
  selectboxBlacklist: _propTypes.array,
